...
const spam5 = document.querySelector('.irvin5');
const delte5 = document.querySelector('.closed5');
spam5.addEventListener('click', ()=>{
delte5.classList.remove('closed5')
spam5.addEventListener('click', ()=>{
  delte5.classList.toggle('closed5')
});
});
...
const rotate5 = document.querySelector('.type5');
const rotatefinal5 = document.querySelector('.irvin5')
rotatefinal5.addEventListener('click', () => {
rotate5.classList.toggle('rotate-90')
});
...
const Newrota6 = document.querySelector('.rota6');
const rota6 = document.querySelector('.denk6')
rota6.addEventListener('click', () => {
Newrota6.classList.toggle('rotate-90')
});
...
const hamburg6 = document.querySelector('.denk6');
const suprime6 = document.querySelector('.hd6');
hamburg6.addEventListener('click', ()=>{
suprime6.classList.toggle('closed5')
hamburg6.addEventListener('click', ()=>{
  suprime6.classList.remove('closed5')
  hamburg6.addEventListener('click', ()=>{
    suprime6.classList.toggle('closed5')
  });
});
...
const researched = [
  ...
  { title: 'Nala', excerpt: 'Nala', url: '/webservice/#/Secondproject', link: '/webservice/#/Secondproject', paragraph:'Nala is a brand and business that provides E-commerce & E-business services to companies or start-ups which are migrating their business to the digital world. We provide services.' },
  ...
  { title: 'World Trade Agreements', excerpt: 'Agreements', url: '/webservice/#/Tooltraffic', link: '/webservice/#/Tooltraffic', paragraph: 'The World Trade Organization (WTO) is an intergovernmental organization that regulates and facilitates international trade between nations. It officially commenced operations on 1 January 1995, pursuant to the 1994 Marrakesh Agreement, thus replacing the General Agreement on Tariffs and Trade (GATT) that had been established in 1948. The WTO is the world largest international economic organization, with 164 member states representing over 96% of global trade and global GDP.' },
  { title: 'Expot tool', excerpt: 'Export Tool', url: '/webservice/#/Expoinfo', link: '/webservice/#/Expoinfo', paragraph: 'Find out more information according with each parameter you select.' },
  { title: 'Import tool', excerpt: 'Import Tool', url: '/webservice/#/Impoinfo', link: '/webservice/#/Impoinfo', paragraph: 'Find out more information according with each parameter you select.' },
  { title: 'Tariffs lines', excerpt: 'National Tariffs', url: '/webservice/#/Tariffsinfo', link: '/webservice/#/Tariffsinfo', paragraph: 'Find out more information according with each parameter you select.' },
]
...
const researched1 = [
  { title: 'Introduction', excerpt: 'Introduction', url: '/webservice/#/Introduction', link: '/webservice/#/Introduction', paragraph: 'This Website is intended to be a guide for those who want to start their own ecommerce website or event a personal blog, also this website is meant to everyone who is learning about software-programming. In this website you can find my journey on build my own website and also you can find some tips and tricks that I have learned along the way. The tootls and technologies that I have used are mainly free and open source, so you can use them too. Having said that, I hope you enjoy this website and if you have any questions or suggestions, please feel free to contact me.' },
  { title: 'Ecommerce', excerpt: 'Ecommerce', url: '/webservice/#/Firstproject', link: '/webservice/#/Firstproject', paragraph: 'The ecommerce is one of the most common React web application a developer can be asked to build. Here is why knowing how to properly craft an ecommerce application from the ground up can be considered a crucial skill. Over the last few years, several libraries have been built to help developers reach this goal effortlessly. Specifically, Snipcart is the solution you are looking for. Not only does it allow you to set up an ecommerce in a few minutes, but it is also a secure, reliable, and advanced solution. Read this article instead, if you want to build a Next.js ecommerce.' },
  { title: 'QChimba', excerpt: 'Qchimba', url: '/webservice/#/Secondproject', link: '/webservice/#/Secondproject', paragraph:'QChimba is a brand and business that provides E-commerce & E-business services to companies or start-ups which are migrating their business to the digital world. We provide services.' },
